...
function Published() {
  const options = [
    { label: "Hariri Chapisho", onClick: () => alert("Option 1 clicked") },
    { label: "Futa Chapisho", onClick: () => alert("Option 2 clicked"),},
  ...
  return (
    <div className="flex flex-col border-b border-gray-100 my-2 pt-2 pb-4 max-w-6xl gap-2">
      ...
      <div className="flex flex-row items-center w-full justify-between">
        <div className="text-xs md:text-sm">Imechapishwa siku 10 zilizopita</div>
