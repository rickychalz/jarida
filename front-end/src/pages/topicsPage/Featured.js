...
function Featured() {
  ...
  return (
    <div className="flex items-center relative px-1">
      ...
      <div id="scrollableDiv" ref={scrollableDivRef} onScroll={handleScroll} className="mx-4 bg-white flex gap-5 items-center whitespace-nowrap w-full overflow-x-auto overflow-y-hidden overflow:clip [&::-webkit-scrollbar]:hidden">
        <FeaturedPost />
        <FeaturedPost />
        <FeaturedPost />
        <FeaturedPost />
